...
static SettingsFactory::Bundle FREQ_SETTINGS_BUNDLE_FFF =
{
    ...
    // BBS
    { L("Support")     , { "enable_support", "support_type", "support_threshold_angle", "support_threshold_offset",
...
std::map<std::string, std::vector<SimpleSettingData>>  SettingsFactory::OBJECT_CATEGORY_SETTINGS=
{
    ...
    { L("Support"), {{"brim_type", "",1},{"brim_width", "",2},{"brim_object_gap", "",3},
                    {"enable_support", "",4},{"support_type", "",5},{"support_threshold_angle", "",6}, {"support_threshold_offset", "",6}, {"support_on_build_plate_only", "",7},
...
std::vector<SimpleSettingData> SettingsFactory::get_visible_options(const std::string& category, const bool is_part)
{
    ...
    t_config_option_keys object_options = {
        ...
        //Support
        "enable_support", "support_type", "support_threshold_angle", "support_threshold_offset", "support_on_build_plate_only", "support_critical_regions_only", "enforce_support_layers",
        //tree support
