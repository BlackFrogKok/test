...
static std::vector<std::string> s_Preset_print_options {
    ...
    "brim_width", "brim_object_gap", "brim_type", "brim_ears_max_angle", "brim_ears_detection_length", "enable_support", "support_type", "support_threshold_angle", "support_threshold_offset", "enforce_support_layers",
